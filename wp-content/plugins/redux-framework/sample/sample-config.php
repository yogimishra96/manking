<?php
    ...
    Redux::setSection( $opt_name, array(
		...
		array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Change Logo', 'redux-framework-demo' ),
                'compiler' => 'true',
           ...
           array(
                ...
                'default'  => 'Shop no. 123, Street Name, Land Mark, Pincode 303030',
            ),array(
                'id'       => 'email',
                'type'     => 'text',
			...
			array(
                'id'       => 'youtubevideo',
                'type'     => 'text',
                'title'    => __( 'YouTube Video Url', 'redux-framework-demo' ),
                'default'  => 'https://youtu.be/YF_jnZc0A0A',
            )
